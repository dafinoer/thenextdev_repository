...
class _$ProfileModelTearOff {
  ...
  _ProfileModel call({required String id, String? username, String? name}) {
...
class _$_ProfileModel with DiagnosticableTreeMixin implements _ProfileModel {
  const _$_ProfileModel({required this.id, this.username, this.name});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProfileModel(id: $id, username: $username, name: $name)';
  }
...
abstract class _ProfileModel implements ProfileModel {
  const factory _ProfileModel(
      {required String id, String? username, String? name}) = _$_ProfileModel;
